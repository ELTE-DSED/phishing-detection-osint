...
\begin{figure}
\centering
[width=0.85\linewidth,height=0.65\textheight,keepaspectratio]{images/user-journey.png}
...
The threat level boundaries (Safe < 0.3, Suspicious < 0.5, Dangerous < 0.7, Critical ≥ 0.7) are defined in Section \ref{weighted-verdict-combination}. These drive the color-coded UI recommendations shown to users.
