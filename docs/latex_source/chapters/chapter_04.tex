...
The system initializes ten distinct \texttt{PhraseMatcher} pipelines: 1.
...
winnings''). 9. \texttt{attachmentMatcher}: Detects suspicious file
attachments and malware delivery attempts (e.g., ``.exe,'' ``.zip,'' ``open
the attachment''). 10. \texttt{socialProofMatcher}: Detects fake trust
